...
# # Configure API Key
# genai.configure(api_key="API__HERE")
...
#     prompt = f"""
#     Extract structured data from the following form and return ONLY valid JSON:
#     {text}
#     Ensure the JSON is well-organized with meaningful key-value pairs and contains no extra text.
#     """

#     response = gemini_model.generate_content(prompt)

#     if response and hasattr(response, "text"):
#         # Ensure response is clean and formatted correctly
#         response_text = response.text.strip()
        
#         # Handle potential text wrapping JSON response
...
#             json_data = {"error": "Failed to parse response as JSON. Gemini may have returned incorrect formatting."}
#     else:
...
# # Streamlit UI
# st.title("Form Data Extraction and Structuring using Google Gemini")
# st.write("Upload a **PDF or image** of a form to extract its details and structure them into JSON format.")
...
#             json_output = get_json_from_text(extracted_text)
